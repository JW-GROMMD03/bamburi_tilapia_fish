...
def get_default_menu_items():
    ...
    return [
        ...
        {'id': 16, 'category': 'soda', 'name': 'Soda 300ml', 'price': 50, 'is_active': True},
        {'id': 17, 'category': 'soda', 'name': 'Soda 500ml', 'price': 60, 'is_active': True},
        {'id': 18, 'category': 'soda', 'name': 'Soda 2L', 'price': 200, 'is_active': True},
